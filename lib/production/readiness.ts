...
export function getProductionReadiness() {
  ...
  const checks: ReadinessCheck[] = [
    ...
    check("AGENTROUTER_API_KEY", "Swift AI AgentRouter gateway key", env.openRouterApiKey, "required", "service"),
    check("AGENTROUTER_BASE_URL", "AgentRouter compatible API base URL", env.openRouterBaseUrl, "optional", "service", undefined, true),
    check("AGENTROUTER_SITE_URL", "AgentRouter attribution site URL", env.openRouterSiteUrl, "optional", "service", undefined, true),
    check("AGENTROUTER_APP_NAME", "AgentRouter attribution app name", env.openRouterAppName, "optional", "service", undefined, true),
    check(
      "REDIS_BULLMQ_CONFIG",
