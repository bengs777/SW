...
export function buildArchitectureInstructionBlock(plan: SwiftArchitecturePlan) {
  return [
    ...
    "- Build scaffold and frontend pages before backend, database, auth, payment, or external integration files.",
    "- Use local typed data and safe UI states until frontend preview validation passes.",
