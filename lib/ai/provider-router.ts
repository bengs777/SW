...
const FILE_OUTPUT_SYSTEM_PROMPT = [
  ...
  'Required JSON schema: {"kind":"generated_project_artifact","framework":"Next.js","files":[],"dependencies":[],"commands":[],"summary":"short execution summary","taskGraph":{"intent":"domain-specific intent","summary":"short execution summary","dependencies":["lucide-react"],"operations":[{"id":"op-1","action":"create|modify|delete","path":"app/page.tsx","language":"tsx","content":"full file content","reason":"why this operation is needed"}]},"diagnostics":[],"metadata":{},"repairs":[]}.',
  ...
  "Use framework and metadata for labels like Next.js, React, or TypeScript. Use taskGraph.operations for every file mutation. Use action delete only when the user asks to remove a file or a file is clearly obsolete.",
